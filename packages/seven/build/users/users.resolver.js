...
var UsersResolver = /** @class */ (function () {
    ...
    UsersResolver.prototype.Users = function (userName) {
    ...
    UsersResolver.prototype.addUser = function (newUser) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.create(newUser)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    __decorate([
        ...
        __metadata("design:returntype", Promise)
    ], UsersResolver.prototype, "addUser");
