...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.findOne = function (user_name) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            return [2 /*return*/, E.left(new common_1.ForbiddenException("User not found"))];
                        }
                        return [2 /*return*/, E.right(user)];
                }
            });
        });
    };
    UsersService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _b = (_a = this.usersRepository).save;
                        _c = [__assign({}, data)];
                        _d = {};
                        return [4 /*yield*/, bcrypt.hash(data.password, 10)];
                    case 1: return [2 /*return*/, _b.apply(_a, [__assign.apply(void 0, _c.concat([(_d.password = _e.sent(), _d)]))])];
                }
            });
        });
    };
